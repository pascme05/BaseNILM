...
# Names
# ------------------------------------------
setupExp['name'] = 'Tutorial_3_LF'                                                                                      # Name of the simulation
...
setupDat['train'] = ['redd3LF']                                                                                         # name of training datasets (multiple)
setupDat['test'] = 'redd3LF'                                                                                            # name of testing datasets (one)
setupDat['val'] = 'redd3LF'                                                                                             # name of validation dataset (one)
...
setupPar['overlap'] = 54                                                                                                # overlap between consecutive windows (no overlap during test if -1)
