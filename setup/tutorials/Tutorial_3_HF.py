...
# Names
# ------------------------------------------
setupExp['name'] = 'Tutorial_3_HF'                                                                                      # Name of the simulation
...
setupDat['freq'] = 'HF'                                                                                                 # 'LF': low-frequency data, 'HF': high-frequency data
...
setupDat['train'] = ['redd3HF']                                                                                         # name of training datasets (multiple)
setupDat['test'] = 'redd3HF'                                                                                            # name of testing datasets (one)
setupDat['val'] = 'redd3HF'                                                                                             # name of validation dataset (one)

# ------------------------------------------
# Input/ Output Mapping
# ------------------------------------------
setupDat['inp'] = []                                                                                                    # names of the input variables (X), if empty all features are used
setupDat['out'] = ['FRE', 'DWE', 'WAD']                                                                                 # names of the output variables (y), if empty all appliances are used
...
setupPar['model'] = 'CNN2'                                                                                              # possible classifier: 1) ML: RF, CNN, LSTM \ 2) PM: DTW, MVM \ 3) SS: NMF, SCA
setupPar['modelInpDim'] = 4                                                                                             # model input dimension 3D or 4D (e.g. for CNN2D)
...
setupPar['window'] = 55                                                                                                 # window length (samples)
