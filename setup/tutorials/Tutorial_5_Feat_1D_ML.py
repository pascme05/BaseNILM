...
# Names
# ------------------------------------------
setupExp['name'] = 'Tutorial_5_Feat_1D_ML'                                                                              # Name of the simulation
...
setupPar['model'] = 'RF'                                                                                                # possible classifier: 1) ML: RF, CNN, LSTM \ 2) PM: DTW, MVM \ 3) SS: NMF, SCA
...
setupPar['feat'] = 1                                                                                                    # 0) raw data values, 1) statistical features (frame based), 2) statistical features (input based), 3) input and frame based features, 4) 2D features
