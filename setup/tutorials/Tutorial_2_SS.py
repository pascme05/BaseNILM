...
# Names
# ------------------------------------------
setupExp['name'] = 'Tutorial_2_SS'                                                                                      # Name of the simulation
...
setupPar['solver'] = 'SS'                                                                                               # TF: Tensorflow, PT: PyTorch, SK: sklearn, PM: Pattern Matching, SS: Source Separation and CU: Custom (placeholder for own ideas)
setupPar['model'] = 'DSC'                                                                                               # possible classifier: 1) ML: RF, CNN, LSTM \ 2) PM: DTW, MVM \ 3) SS: NMF, SCA
...
setupPar['window'] = 1440                                                                                               # window length (samples)
setupPar['overlap'] = 720                                                                                                 # overlap between consecutive windows (no overlap during test if -1)
setupPar['outseq'] = 1440                                                                                               # 0) seq2point, x) length of the subsequence in samples
setupPar['yFocus'] = 720                                                                                                # focus point for seq2point (average if -1)
setupPar['nDim'] = 1                                                                                                    # input dimension for model 1D (1), 2D (2), or 3D (3)
