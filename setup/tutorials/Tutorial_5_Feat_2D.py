...
# Names
# ------------------------------------------
setupExp['name'] = 'Tutorial_5_Feat_2D'                                                                                 # Name of the simulation
...
# ------------------------------------------
setupDat['inp'] = ['P-agg', 'Q-agg']                                                                                    # names of the input variables (X), if empty all features are used
...
setupPar['feat'] = 4                                                                                                    # 0) raw data values, 1) statistical features (frame based), 2) statistical features (input based), 3) input and frame based features, 4) 2D features
...
setupPar['yFocus'] = 8                                                                                                  # focus point for seq2point (average if -1)
