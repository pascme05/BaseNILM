...
# Names
# ------------------------------------------
setupExp['name'] = 'Tutorial_1_ECO'                                                                                     # Name of the simulation
...
setupDat['train'] = ['eco2_1min']                                                                                       # name of training datasets (multiple)
setupDat['test'] = 'eco2_1min'                                                                                          # name of testing datasets (one)
setupDat['val'] = 'eco2_1min'                                                                                           # name of validation dataset (one)
