...
# Names
# ------------------------------------------
setupExp['name'] = 'Tutorial_1_REFIT'                                                                                   # Name of the simulation
...
setupDat['train'] = ['refit2_1min']                                                                                     # name of training datasets (multiple)
setupDat['test'] = 'refit2_1min'                                                                                        # name of testing datasets (one)
setupDat['val'] = 'refit2_1min'                                                                                         # name of validation dataset (one)
