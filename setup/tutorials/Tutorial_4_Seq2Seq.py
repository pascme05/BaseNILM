...
# Names
# ------------------------------------------
setupExp['name'] = 'Tutorial_4_Seq2Seq'                                                                                 # Name of the simulation
...
setupDat['out'] = ['FRE']                                                                                               # names of the output variables (y), if empty all appliances are used
...
setupPar['window'] = 60                                                                                                 # window length (samples)
setupPar['overlap'] = 55                                                                                                # overlap between consecutive windows (no overlap during test if -1)
setupPar['outseq'] = 60                                                                                                 # 0) seq2point, x) length of the subsequence in samples
setupPar['yFocus'] = 30                                                                                                 # focus point for seq2point (average if -1)
