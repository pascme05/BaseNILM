...
#######################################################################################################################
"""
This function calculates the results for the constrained elastic matching using DTW and all loads for the AMPds2
dataset. The approach uses the full sampling resolution of 1/60 Hz and all input feature, the model size is 1% of the
total data. The average accuracy metric for 1-fold validation are (identical as reported in Table 6 of Sub-Section V-B):
...
# Names
# ------------------------------------------
setupExp['name'] = 'Constraint_EM_AMPds2_DEF'                                                                           # Name of the simulation
...
setupPar['model'] = 'DTW'                                                                                               # possible classifier: 1) ML: RF, CNN, LSTM \ 2) PM: DTW, MVM \ 3) SS: NMF, SCA
