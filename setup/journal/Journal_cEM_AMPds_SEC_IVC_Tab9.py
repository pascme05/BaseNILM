...
# File:         Journal_Constraint_EM_AMPds
...
# Names
# ------------------------------------------
setupExp['name'] = 'Constraint_EM_AMPds_DEF'                                                                            # Name of the simulation
...
setupDat['house'] = 0                                                                                                   # only when loading nilmtk converted files with '.h5' format
...
setupDat['outFeat'] = 1                                                                                                 # if data is three-dimensional, the output axis must be defined
...
setupDat['threshold'] = 0.2                                                                                             # 0) no threshold x) threshold to transform regressio into classification data
...
setupPar['outseq'] = 10                                                                                                 # 0) seq2point, x) length of the subsequence in samples
