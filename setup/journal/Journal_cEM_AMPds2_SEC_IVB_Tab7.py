...
#######################################################################################################################
"""
This function calculates the results for the constrained elastic matching using DTW and def loads for the AMPds2
dataset. The approach uses the full sampling resolution of 1/60 Hz and all input feature, the model size is 1% of the
total data. The average accuracy metric for 1-fold validation are (identical as reported in Table 7 of Sub-Section V-B):
