...
(microwave, dishwasher, and fridge) for the REDD-2 dataset. The approach uses the full sampling resolution of 1/3 Hz and
active power as input feature, the model size is 1% of the total data. The average accuracy metric for 10-fold cross-
validation are (identical as reported in Table 13 of Sub-Section V-A):

ACC:    97.11 %
F1:     97.04 %
TECA:   92.51 %
MAE:    4.99
SAE:    0.04 (due to displaying only 2 decimal digits -> 0.035)
"""
...
setupDat['out'] = ['MIC', 'DWE', 'FRE']                                                                                 # names of the output variables (y), if empty all appliances are used
