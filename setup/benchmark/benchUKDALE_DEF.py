...
from mdlParaBench import mdlPara
...
# Names
# ------------------------------------------
setupExp['name'] = 'benchUKDALE_DEF'                                                                                     # Name of the simulation
...
# Datasets
# ------------------------------------------
setupDat['folder'] = 'ukdale'                                                                                            # name of the folder for the dataset under \data
setupDat['house'] = 1                                                                                                    # only when loading nilmtk converted files with '.h5' format
setupDat['train'] = ['ukdale1']                                                                                          # name of training datasets (multiple)
setupDat['test'] = 'ukdale1'                                                                                             # name of testing datasets (one)
setupDat['val'] = 'ukdale1'                                                                                              # name of validation dataset (one)
...
# Sampling
# ------------------------------------------
setupDat['fs'] = 1/8                                                                                                     # sampling frequency (Hz) for HF data this is the LF output frequency of (y)
...
setupDat['threshold'] = 50                                                                                               # 0) no threshold x) threshold to transform regression into classification data
