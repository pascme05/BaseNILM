...
setupDat['train'] = ['redd6']                                                                                            # name of training datasets (multiple)
setupDat['test'] = 'redd6'                                                                                               # name of testing datasets (one)
setupDat['val'] = 'redd6'                                                                                                # name of validation dataset (one)
...
setupPar['model'] = 'TRA'                                                                                                # possible classifier: 1) ML: RF, CNN, LSTM \ 2) PM: DTW, MVM \ 3) SS: NMF, SCA
