...
# Names
# ------------------------------------------
setupExp['name'] = 'benchIAWE_DEF'                                                                                       # Name of the simulation
...
# Datasets
# ------------------------------------------
setupDat['folder'] = 'iawe'                                                                                              # name of the folder for the dataset under \data
setupDat['house'] = 1                                                                                                    # only when loading nilmtk converted files with '.h5' format
setupDat['train'] = ['iawe1']                                                                                            # name of training datasets (multiple)
setupDat['test'] = 'iawe1'                                                                                               # name of testing datasets (one)
setupDat['val'] = 'iawe1'                                                                                                # name of validation dataset (one)
