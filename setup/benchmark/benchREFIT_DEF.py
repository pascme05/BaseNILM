...
# Names
# ------------------------------------------
setupExp['name'] = 'benchREFIT_DEF'                                                                                      # Name of the simulation
...
# Datasets
# ------------------------------------------
setupDat['folder'] = 'refit'                                                                                             # name of the folder for the dataset under \data
setupDat['house'] = 1                                                                                                    # only when loading nilmtk converted files with '.h5' format
setupDat['train'] = ['refit1_1min']                                                                                      # name of training datasets (multiple)
setupDat['test'] = 'refit1_1min'                                                                                         # name of testing datasets (one)
setupDat['val'] = 'refit1_1min'                                                                                          # name of validation dataset (one)
