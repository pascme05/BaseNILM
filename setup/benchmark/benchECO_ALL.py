...
# Names
# ------------------------------------------
setupExp['name'] = 'benchECO_ALL'                                                                                        # Name of the simulation
...
# Datasets
# ------------------------------------------
setupDat['folder'] = 'eco'                                                                                               # name of the folder for the dataset under \data
setupDat['house'] = 1                                                                                                    # only when loading nilmtk converted files with '.h5' format
setupDat['train'] = ['eco1_1min']                                                                                        # name of training datasets (multiple)
setupDat['test'] = 'eco1_1min'                                                                                           # name of testing datasets (one)
setupDat['val'] = 'eco1_1min'                                                                                            # name of validation dataset (one)
